...
> Vercel-এর মতো read-only serverless হোস্টে অ্যাডমিন সেভ/আপলোড কাজ করবে না —
> সেখানে হোস্ট করলে `data/*.json` সরাসরি রিপোতে এডিট করে ডিপ্লয় করতে হবে।
...
- The Bengalee আর্টিকেলের সরাসরি লিংক (এখন হোমপেজ দেওয়া)
- বইয়ের প্রকাশনার সাল ও কভার ছবি; বই একাধিক হলে বাকিগুলোর তথ্য
